\begin{frame}[fragile,shrink=5]
  ...
  \begin{block}{Métodos Estadísticos}
    ...
    \begin{itemize}
      \item ✓ Eficaces a corto plazo ($<$72 horas)
      \item ✗ Desconectados de física fundamental
      \item ✗ Fallan ante eventos extremos sin precedentes
    \end{itemize}
  \end{block}
...
\begin{frame}[fragile]
  ...
  \begin{block}{Machine Learning Convencional (GraphCast, FourCastNet)}
    \begin{itemize}
      \item ✓ Rápidos: predicciones en minutos (vs. horas en NWP)
      \item ✓ Entrenados con décadas de datos ERA5
      \item ✗ Inconsistencias físicas: $\sim$5\% violación de energía
      \item ✗ Caja negra: imposible explicabilidad física
    \end{itemize}
  \end{block}
